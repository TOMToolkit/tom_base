...
class Command(BaseCommand):
    ...
    def welcome_banner(self):
        welcome_text = (
            'Welcome to the bhtom_setup helper script. This will help you get started with a new TOM.\n'
    ...
    def generate_config(self):
        ...
        template = get_template('bhtom_setup/settings.tmpl')
    ...
    def generate_urls(self):
        ...
        template = get_template('bhtom_setup/urls.tmpl')
        rendered = template.render(self.context)
