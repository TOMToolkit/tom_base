...
from bhtom_targets.models import Target, TargetExtra, TargetList
from bhtom_targets.forms import TargetVisibilityForm

register = template.Library()


@register.inclusion_tag('bhtom_targets/partials/recent_targets.html', takes_context=True)
def recent_targets(context, limit=10):
    ...
    return {'targets': get_objects_for_user(user, 'bhtom_targets.view_target').order_by('-created')[:limit]}


@register.inclusion_tag('bhtom_targets/partials/recently_updated_targets.html', takes_context=True)
def recently_updated_targets(context, limit=10):
    ...
    """
    user = context['request'].user
    return {'targets': get_objects_for_user(user, 'bhtom_targets.view_target').order_by('-modified')[:limit]}


@register.inclusion_tag('bhtom_targets/partials/target_feature.html')
...
@register.inclusion_tag('bhtom_targets/partials/target_buttons.html')
...
@register.inclusion_tag('bhtom_targets/partials/target_data.html')
...
@register.inclusion_tag('bhtom_targets/partials/target_unknown_statuses.html')
...
@register.inclusion_tag('bhtom_targets/partials/target_groups.html')
...
@register.inclusion_tag('bhtom_targets/partials/moon_distance.html')
def moon_distance(target, day_range=30, width=600, height=400, background=None, label_color=None, grid=True):
    ...
    :type target: bhtom_targets.models.Target
...
@register.inclusion_tag('bhtom_targets/partials/targetlist_select.html')
...
@register.inclusion_tag('bhtom_targets/partials/aladin.html')
def aladin(target):
    """
