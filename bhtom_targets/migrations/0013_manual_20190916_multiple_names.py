...
def copy_names_from_target_to_targetnames(apps, schema_editor):
    targets = apps.get_model('bhtom_targets', 'Target')
    for row in targets.objects.all():
        target_name = apps.get_model('bhtom_targets', 'TargetName')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bhtom_targets', '0012_target_perihdist'),
    ]
