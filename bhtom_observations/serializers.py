...
from bhtom_base.bhtom_observations.models import ObservationGroup, ObservationRecord
    ...
    def create(self, validated_data):
        ...
        if group_serializer.is_valid() and settings.TARGET_PERMISSIONS_ONLY is False:
            for group in groups:
                ...
                assign_perm('bhtom_observations.view_observationrecord', group_instance, obsr)
                assign_perm('bhtom_observations.change_observationrecord', group_instance, obsr)
                assign_perm('bhtom_observations.delete_observationrecord', group_instance, obsr)
...
class ObservationRecordFilteredPrimaryKeyRelatedField(serializers.PrimaryKeyRelatedField):
    ...
    def get_queryset(self) -> QuerySet:
        ...
        if settings.TARGET_PERMISSIONS_ONLY:
            ...
            return get_objects_for_user(request.user, 'bhtom_observations.change_observation')
