...
@register.inclusion_tag('bhtom_observations/partials/update_status_button.html', takes_context=True)
...
@register.inclusion_tag('bhtom_observations/partials/update_observation_id_form.html')
...
@register.inclusion_tag('bhtom_observations/partials/observation_type_tabs.html', takes_context=True)
...
@register.inclusion_tag('bhtom_observations/partials/facility_observation_form.html')
...
@register.inclusion_tag('bhtom_observations/partials/observation_plan.html')
...
@register.inclusion_tag('bhtom_observations/partials/observation_list.html', takes_context=True)
...
@register.inclusion_tag('bhtom_observations/partials/observationtemplate_run.html')
...
@register.inclusion_tag('bhtom_observations/partials/observationtemplate_from_record.html')
...
@register.inclusion_tag('bhtom_observations/partials/observation_distribution.html')
...
@register.inclusion_tag('bhtom_observations/partials/facility_status.html')
def facility_status():
    """
...
@register.inclusion_tag('bhtom_observations/partials/facility_map.html')
def facility_map():
    facility_locations = []
    for facility_class in get_service_classes().values():
        facility = facility_class()
