...
from bhtom_base.bhtom_observations.facilities.soar import make_request, SOARBaseObservationForm, SOARImagingObservationForm
from bhtom_base.bhtom_observations.facilities.soar import SOARSpectroscopyObservationForm
from bhtom_base.bhtom_observations.tests.factories import NonSiderealTargetFactory, SiderealTargetFactory
...
class TestMakeRequest(TestCase):
    ...
    @patch('bhtom_base.bhtom_observations.facilities.soar.requests.request')
...
class TestSOARBaseObservationForm(TestCase):
    ...
    @patch('bhtom_base.bhtom_observations.facilities.soar.make_request')
    @patch('bhtom_base.bhtom_observations.facilities.soar.cache')
    ...
    @patch('bhtom_base.bhtom_observations.facilities.soar.SOARBaseObservationForm.proposal_choices')
    @patch('bhtom_base.bhtom_observations.facilities.soar.SOARBaseObservationForm.filter_choices')
    @patch('bhtom_base.bhtom_observations.facilities.soar.SOARBaseObservationForm.instrument_choices')
    @patch('bhtom_base.bhtom_observations.facilities.soar.SOARBaseObservationForm.validate_at_facility')
...
@patch('bhtom_base.bhtom_observations.facilities.soar.SOARImagingObservationForm._get_instruments')
...
class TestSOARSpectroscopyObservationForm(TestCase):
    ...
    @patch('bhtom_base.bhtom_observations.facilities.soar.SOARSpectroscopyObservationForm._get_instruments')
    def test_instrument_choices(self, mock_get_instruments):
    ...
    @patch('bhtom_base.bhtom_observations.facilities.soar.SOARSpectroscopyObservationForm.proposal_choices')
    @patch('bhtom_base.bhtom_observations.facilities.soar.SOARSpectroscopyObservationForm.filter_choices')
    @patch('bhtom_base.bhtom_observations.facilities.soar.SOARSpectroscopyObservationForm.instrument_choices')
    @patch('bhtom_base.bhtom_observations.facilities.soar.SOARSpectroscopyObservationForm.validate_at_facility')
