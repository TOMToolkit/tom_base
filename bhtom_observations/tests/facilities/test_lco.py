...
from bhtom_observations.facilities.lco import make_request, LCOFacility
from bhtom_observations.facilities.lco import LCOBaseForm, LCOBaseObservationForm, LCOImagingObservationForm
from bhtom_observations.facilities.lco import LCOPhotometricSequenceForm, LCOSpectroscopicSequenceForm
from bhtom_observations.facilities.lco import LCOSpectroscopyObservationForm, LCOMuscatImagingObservationForm
from bhtom_observations.tests.factories import SiderealTargetFactory, NonSiderealTargetFactory
...
class TestMakeRequest(TestCase):
    ...
    @patch('bhtom_observations.facilities.lco.requests.request')
...
class TestLCOBaseForm(TestCase):
    ...
    @patch('bhtom_observations.facilities.lco.make_request')
    @patch('bhtom_observations.facilities.lco.cache')
    ...
    @patch('bhtom_observations.facilities.lco.LCOBaseForm._get_instruments')
...
@patch('bhtom_observations.facilities.lco.LCOBaseObservationForm.proposal_choices')
@patch('bhtom_observations.facilities.lco.LCOBaseObservationForm.filter_choices')
@patch('bhtom_observations.facilities.lco.LCOBaseObservationForm.instrument_choices')
@patch('bhtom_observations.facilities.lco.LCOBaseObservationForm.validate_at_facility')
class TestLCOBaseObservationForm(TestCase):
    ...
    @patch('bhtom_observations.facilities.lco.LCOBaseObservationForm._build_location')
    @patch('bhtom_observations.facilities.lco.LCOBaseObservationForm._build_configuration')
    @patch('bhtom_observations.facilities.lco.make_request')
...
@patch('bhtom_observations.facilities.lco.LCOImagingObservationForm._get_instruments')
...
@patch('bhtom_observations.facilities.lco.LCOMuscatImagingObservationForm.validate_at_facility')
@patch('bhtom_observations.facilities.lco.LCOMuscatImagingObservationForm.filter_choices')
@patch('bhtom_observations.facilities.lco.LCOMuscatImagingObservationForm.proposal_choices')
@patch('bhtom_observations.facilities.lco.LCOMuscatImagingObservationForm._get_instruments')
...
class TestLCOSpectroscopyObservationForm(TestCase):
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopyObservationForm._get_instruments')
    def test_instrument_choices(self, mock_get_instruments):
    ...
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopyObservationForm.proposal_choices')
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopyObservationForm.filter_choices')
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopyObservationForm.instrument_choices')
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopyObservationForm.validate_at_facility')
    def test_build_instrument_config(self, mock_validate, mock_insts, mock_filters, mock_proposals):
        mock_validate.return_value = []
...
class TestLCOPhotometricSequenceForm(TestCase):
    ...
    @patch('bhtom_observations.facilities.lco.LCOPhotometricSequenceForm._get_instruments')
    def test_instrument_choices(self, mock_get_instruments):
    ...
    @patch('bhtom_observations.facilities.lco.LCOPhotometricSequenceForm.proposal_choices')
    @patch('bhtom_observations.facilities.lco.LCOPhotometricSequenceForm.filter_choices')
    @patch('bhtom_observations.facilities.lco.LCOPhotometricSequenceForm.instrument_choices')
    @patch('bhtom_observations.facilities.lco.LCOPhotometricSequenceForm.validate_at_facility')
    def test_build_instrument_config(self, mock_validate, mock_insts, mock_filters, mock_proposals):
        mock_validate.return_value = []
        mock_insts.return_value = self.instrument_choices
        mock_filters.return_value = self.filter_choices
...
class TestLCOSpectroscopicSequenceForm(TestCase):
    ...
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopicSequenceForm._get_instruments')
    def test_instrument_choices(self, mock_get_instruments):
    ...
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopicSequenceForm.proposal_choices')
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopicSequenceForm.filter_choices')
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopicSequenceForm.instrument_choices')
    @patch('bhtom_observations.facilities.lco.LCOSpectroscopicSequenceForm.validate_at_facility')
    def test_build_instrument_config(self, mock_validate, mock_insts, mock_filters, mock_proposals):
        mock_validate.return_value = []
        mock_insts.return_value = self.instrument_choices
        mock_filters.return_value = self.filter_choices
