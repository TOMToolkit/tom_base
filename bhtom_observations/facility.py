...
class BaseObservationForm(forms.Form):
    ...
    https://github.com/TOMToolkit/tom_base/blob/main/bhtom_observations/facilities/lco.py#L132
    """
...
class BaseRoboticObservationFacility(BaseObservationFacility):
    ...
    For an implementation example, please see
    https://github.com/TOMToolkit/tom_base/blob/main/bhtom_observations/facilities/lco.py
    """
