...
from django_bootstrap5.templatetags.django_bootstrap5 import get_pagination_context, register
from django.conf import settings
from django.core.paginator import Page


@register.inclusion_tag("bootstrap5_overrides/pagination.html")
