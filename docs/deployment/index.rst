...
important to get right.  :doc:`General Deployment Tips <deployment_tips> covers these fundamentals.
...
so we use this as a guide to the process in :doc:`Deploy to Heroku <deployment_heroku>`.

Data storage
------------

Cloud providers also offer general-purpose data storage, which is often value for TOM-related data products.
:doc:`Using Amazon S3 to Store Data for a TOM <amazons3>` demonstrates how to enable storing data on the cloud storage
