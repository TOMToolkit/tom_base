        ...
        for alert_id in alerts:
            ...
            try:
                ...
                for group in request.user.groups.all():
                    ...
                    for reduced_datum in target.reduceddatum_set.all():
                        assign_perm('tom_dataproducts.view_reduceddatum', group, reduced_datum)
                        assign_perm('tom_dataproducts.change_reduceddatum', group, reduced_datum)
                        assign_perm('tom_dataproducts.delete_reduceddatum', group, reduced_datum)
