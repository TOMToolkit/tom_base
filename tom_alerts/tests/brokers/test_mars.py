...
from bhtom_base.tom_alerts.brokers.mars import MARSBroker
...
@override_settings(TOM_ALERT_CLASSES=['bhtom_base.tom_alerts.brokers.mars.MARSBroker'])
class TestMARSBrokerClass(TestCase):
    ...
    @mock.patch('bhtom_base.tom_alerts.brokers.mars.requests.get')
    ...
    @mock.patch('bhtom_base.tom_alerts.brokers.mars.MARSBroker.fetch_alert')
