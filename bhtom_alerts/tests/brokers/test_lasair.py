...
from bhtom_alerts.brokers.lasair import LasairBroker, LasairBrokerForm
...
@override_settings(TOM_ALERT_CLASSES=['bhtom_alerts.brokers.lasair.LasairBroker'])
class TestLasairBrokerClass(TestCase):
    ...
    @mock.patch('bhtom_alerts.brokers.lasair.requests.get')
