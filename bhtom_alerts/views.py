...
class BrokerQueryCreateView(LoginRequiredMixin, FormView):
    ...
    """
    template_name = 'bhtom_alerts/query_form.html'
...
class RunQueryView(TemplateView):
    ...
    """
    template_name = 'bhtom_alerts/query_result.html'
        ...
        for alert_id in alerts:
            ...
            try:
                ...
                for group in request.user.groups.all().exclude(name='Public'):
                    assign_perm('bhtom_targets.view_target', group, target)
                    assign_perm('bhtom_targets.change_target', group, target)
                    assign_perm('bhtom_targets.delete_target', group, target)
