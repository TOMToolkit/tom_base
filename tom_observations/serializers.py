...
class FacilitySerializer(serializers.ModelSerializer):
    ...
    elevation = serializers.FloatField(min_value=-3000.0, max_value=5000.0, required=False)
    orbit = serializers.CharField(max_length=20, required=False)
    diameter = serializers.FloatField(min_value=0, max_value=50.0, required=False)
