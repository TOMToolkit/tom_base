...
from bhtom_base.tom_observations.utils import get_astroplan_sun_and_time, get_sidereal_visibility
from bhtom_base.tom_observations.tests.utils import FakeRoboticFacility
from bhtom_base.tom_observations.models import ObservationRecord, ObservationGroup, ObservationTemplate
...
class TestObservationCancelView(TestCase):
    ...
    @mock.patch('bhtom_base.tom_observations.tests.utils.FakeRoboticFacility.get_observation_status')
    ...
    @mock.patch('bhtom_base.tom_observations.tests.utils.FakeRoboticFacility.cancel_observation')
...
class TestGetVisibility(TestCase):
    ...
    @mock.patch('bhtom_base.tom_observations.utils.facility.get_service_classes')
