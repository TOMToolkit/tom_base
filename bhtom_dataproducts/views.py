...
from bhtom_dataproducts.models import DataProduct, DataProductGroup, ReducedDatum
...
class DataProductDeleteView(Raise403PermissionRequiredMixin, DeleteView):
    ...
    """
    model = DataProduct
    permission_required = 'bhtom_dataproducts.delete_dataproduct'
...
class DataProductGroupDataView(LoginRequiredMixin, FormView):
    ...
    template_name = 'bhtom_dataproducts/add_product_to_group.html'
