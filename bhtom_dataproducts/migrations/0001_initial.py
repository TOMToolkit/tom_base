...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('bhtom_targets', '0004_auto_20190123_2010'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            ...
            name='group',
            field=models.ManyToManyField(to='bhtom_dataproducts.DataProductGroup'),
        ),
        migrations.AddField(
            model_name='dataproduct',
            name='observation_record',
            field=models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.CASCADE, to='bhtom_observations.ObservationRecord'),
        ),
        migrations.AddField(
            model_name='dataproduct',
            name='target',
